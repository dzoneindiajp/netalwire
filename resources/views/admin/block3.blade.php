...
<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="row">
						<h3 class="title1">Block 3 :</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" method="post" action="<?php echo url("saveourblock");?>" enctype="multipart/form-data">
							@csrf
					...
					<div class="form-group">
						...
						<div class="dol-md-12">
							...
							<tr>
							   ...
							   <td>
							       <div class="vid">
							       <!--<img src="<?php echo url("thumbnail/".$dt->image);?>" class="img-responsive" style="max-width:300px">-->
                                    @if($dt->type_name=='image')
                                    <img src="<?php echo url("thumbnail/".$dt->image);?>" class="img-responsive" style="max-width:300px;height:200px;">
							   ...
							   <td style=""><?php echo $dt->title;?></td>
							    ...
							    <td style="">
									...
									<a href="<?php echo url("update-block-three-status/0/".$dt->ob_id);?>" class="btn btn-success">Active</a>
									
									<?php }
									else{?>
									<a href="<?php echo url("update-block-three-status/1/".$dt->ob_id);?>"  class="btn btn-danger">Inactive</a>
									<?php } ?>
								
								</td>
							   <td>
							   <a href="<?php echo url("editblock3/".$dt->ob_id);?>" class="btn btn-danger"><i class="fa fa-edit lg-x"></i></a>
							   
							   <a href="<?php echo url("deleteourblock/".$dt->ob_id);?>" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger"><i class="fa fa-trash lg-x"></i></a>
							   </td>
							</tr>
							<?php } ?>
							</table>
