...
<div id="page-wrapper">
   <div class="main-page">
      <div class="forms">
         <div class="row">
            <h3 class="title1">Edit About Block :</h3>
            <div class="form-three widget-shadow">
               <form class="form-horizontal" method="post" action="<?php echo url("updateaboutblock");?>" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="form-group" id="doc_div" style="<?php echo (!in_array($data->type_name, array('image','video'))) ? 'display:none' : '' ?>">
                     ...
                     <div class="col-sm-4">
                        ...
                        <div id="doc_video_div">
                           <input type="file" class="form-control1" name="text_video" id="text_video" onchange="validatevideo(this,50)">
                        </div>
                        <!--<img src="<?php echo url("uploads/".$data->about_image);?>" style="height:200px;">-->
                        @if($data->type_name=='image')
                        <img src="<?php echo url("uploads/".$data->about_image);?>" class="img-responsive" style="width:200px;height:200px;">
                        @elseif($data->type_name == 'video')
                        <video width="200" height="200" controls>
                           <source src="<?php echo url("uploads/".$data->about_image);?>" type="video/mp4">
                           <source src="<?php echo url("uploads/".$data->about_image);?>" type="video/mp4">
                           Your browser does not support the video tag.
                        </video>
                        @else
                        <!----iframe width="320" height="240" src="{{ $data->video_link }}" frameborder="0" allowfullscreen></iframe --->												{!! $data->video_link !!}
                        @endif
                     </div>
                  ...
                  <div class="form-group" id="video_div" style="<?php echo (!in_array($data->type_name, array('youtube','vimeo'))) ? 'display:none' : '' ?>">
                     ...
                     <div class="col-sm-4">
                        <input type="text" name="video_link" class="form-control" value="" placeholder="Video Link">
                        ...
                        @else
                        <!-----iframe width="320" height="240" src="<?php echo $data->video_link;?>" frameborder="0" allowfullscreen></iframe---->												<div class="vid">							{!! $data->video_link !!}
						 </div>						 @endif                     </div>
                  </div>
                  <div class="form-group">
                     <label for="focusedinput" class="col-sm-2 control-label">Title:</label>
                     <div class="col-sm-4">
                        <input type="text" class="form-control1" id="title" name="title" required value="<?php echo $data->title?>">
                     </div>
                  </div>
                  <div class="form-group">
