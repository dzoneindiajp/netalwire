  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addEditModalLabel">Add Sub Option</h5>
      ...
      <div class="modal-body"> 
         ...
         <input type="hidden" name="contact_position" id="contact_position" value="{{$parent->contact_position}}">
          ...
          console.log($(this));
             ...
             $.ajax({
                 ...
                 success: function (data, status, xhr) {
                     $('#addEditModalLabel').text('Edit Sub Option');
                     if (data.status == 1) {
