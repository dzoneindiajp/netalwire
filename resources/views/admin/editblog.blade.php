						...
						<div class="form-three widget-shadow">
							...
							<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<img src="{{ url("uploads/".$blogs->banner_image) }}" style="height:200px;">

										@endif

										<input type="hidden" name="oldimg1" value="{{ $blogs->banner_image}}">	
								...
								<div class="form-group" >
									...
									<div class="col-sm-4">
										...
										<option value="image" <?php if($blogs->type_name == 'image') { echo 'selected';} ?>>Image</option>

										<option value="video" <?php if($blogs->type_name == 'video') { echo 'selected';} ?>>Video</option>

										<option value="youtube" <?php if($blogs->type_name == 'youtube') { echo 'selected';} ?>>Youtube</option>

										<option value="vimeo" <?php if($blogs->type_name == 'vimeo') { echo 'selected';} ?>>Vimeo</option>
							...
							<div class="form-group"  id="doc_div" style="<?php echo (!in_array($blogs->type_name, array('image','video'))) ? 'display:none' : '' ?>">

									<label  class="col-sm-2 control-label">Upload <?php echo ($blogs->type_name == "image") ? 'Image' : 'Video' ?>:</label>

									<div class="col-sm-8">
										<div id="doc_img_div" style="<?php echo ($blogs->type_name != "image") ? 'display:none' : '' ?>">
											<input type="file" class="form-control" id="image" name="image" onchange="validateimg(this,500,281)">
										...
										<div id="doc_video_div" style="<?php echo ($blogs->type_name != "video") ? 'display:none' : '' ?>">
								...
								<div class="form-group" id="video_div" style="<?php echo (!in_array($blogs->type_name, array('youtube','vimeo'))) ? 'display:none' : '' ?>">

									<label for="focusedinput" class="col-sm-2 control-label">Video Link :</label>

									<div class="col-sm-4">

										<input type="text" name="video_link" class="form-control" value="<?php //echo $blogs->video_link;?>" placeholder="Video Link">
									...
									<div class="col-sm-10">
										 ...
										 <?php if($blogs->type_name == 'image'){ ?> 

        							       <img src="<?php echo url("thumbnail/".$blogs->image);?>" class="img-responsive" style="max-width:300px">

        							       <?php }else if($blogs->type_name == 'video'){ ?>

            							       <video width="320" height="240" controls>

                                                  <source src="<?php echo url("uploads/".$blogs->image);?>" type="video/mp4">
        						          ...
        						          <?php }else if($blogs->type_name == 'youtube' || $blogs->type_name == 'vimeo'){ ?>
											 
            							       <!----iframe width="320" height="240" src="<?php echo $blogs->video_link;?>" frameborder="0" allowfullscreen></iframe---->
    ...
    <label class="radio-inline">
      ...
      <input type="radio" name="status" <?php if($blogs->status==0){ echo "checked";}?> value="0"> Inactive
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<label class="radio-inline">
										<input type="checkbox" name="is_home"  value="1" @if($blogs->is_home) checked @endif> Show on Home Page
										</label>
									</div>
								</div>
