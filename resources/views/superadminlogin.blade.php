...
<div class="main-content">
		...
		<div id="page-wrapper">
			...
			<div align="center">
			<img src="<?php echo url("front/images/logo.png");?>" width="200px" style="margin:0px auto">
			</div>
		...
		<!--footer-->
		<div class="footer">
		   <p>&copy; <?php echo date("Y");?>. All Rights Reserved | Developed by <a href="https://dzoneindia.co.in/" target="_blank">Dzone India Softwares</a></p>		</div>
        <!--//footer-->
	</div>
