...
<div class="page-banner-section">
    ...
    @if($banner_image->news_image && $banner_image->news_image!==null)
    <div class="page-banner page-banner-image"
    style="background-image:url(<?php echo url("thumbnail/".$banner_image->news_image);?>);">
        @else
        <div class="page-banner page-banner-image" >
        @endif
                                        ...
                                        <div class="blog-wrap">
                                            <div class="blog-image">
                                                <a href="{{url('news-detail/'.$dt->id)}}">
                    					            ...
                    					            @elseif($dt->type_name == 'youtube' || $dt->type_name == 'vimeo')
                                            ...
                                            <div class="blog-summery">
                                                <h4 class="blog-title"><a href="{{url('news-detail/'.$dt->id)}}"><?= $dt->title;?></a></h4> 
                                                <div class="blog-content">
                                                    <p><?= $dt->description;?></p>
                                                </div>
                                                <a class="blog-more-link" href="{{url('news-detail/'.$dt->id)}}">Read More</a>
