 ...
 var i = 1;
    ...
    $("#add-item").submit(function (e) {
        ...
        var item =
            ...
            '<p><label for="">Navigation Label<br><input type="text" id="name-'+i+'" name="navigation_label" value="' + label + '"></label></p>' +
            '<p><label for="">Navigation Url<br><input type="text" id="url-'+i+'" name="navigation_url" value="' + url + '"></label></p>' +
